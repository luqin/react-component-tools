...
var _NotifyPlugin = require('./NotifyPlugin');

var _NotifyPlugin2 = _interopRequireDefault(_NotifyPlugin);
...
exports['default'] = function (isDevelopment, config) {
    ...
    return {
        ...
        entry: {
            app: isDevelopment ? ['webpack-dev-server/client?http://localhost:' + port,
        ...
        plugins: (function () {
            ...
            if (isDevelopment) {
                plugins.push(_NotifyPlugin2['default'], new _webpack2['default'].HotModuleReplacementPlugin());
            } else {
                plugins.push(
