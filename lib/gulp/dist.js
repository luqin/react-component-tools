...
exports['default'] = function (gulp, config) {
  ...
  function buildScss(src, dist, title) {
    ...
    .pipe(gulp.dest(dist)).pipe((0, _gulpRename2['default'])(config.component.pkgName + '.min.css')).pipe((0, _gulpCleanCss2['default'])()).pipe(gulp.dest(dist)).pipe((0, _gulpSize2['default'])({ title: title }));
  }
